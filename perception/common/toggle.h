...
class Toggle final
{
  public:
    ...
    constexpr explicit Toggle(const T state_on, const T state_off)
    ...
    constexpr void SetToggleDuration(const std::chrono::milliseconds toggle_duration)
    {
    ...
    constexpr void Update(const std::chrono::milliseconds delta_duration)
    {
